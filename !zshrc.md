...
alias bbp="bun run build && bun run preview"
alias bbs="bun run build && bun run start"
alias bc="bun run check"
alias bcf="bun run check:format"
alias bcl="bun run check:lint"
alias bct="bun run check:type"
alias bd="bun run dev"
alias bi="bun install"
alias bp="bun run preview"
alias br="bun run"
alias brr="bun run release"
alias bs="bun run start"
alias bu="bun run update"
